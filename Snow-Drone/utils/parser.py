...
def parse_args():
    ...
    parser.add_argument("-sd", "--strobe_duration", type=int, default=300, required=False) # Set default strobe duration to 300 us
    ...
    parser.add_argument("-set", "--sharp_edges_threshold", type=int, default=350, required=False) # Set default gradient threshold to 200 (empirical value)
